...
<body>
    ...
    <section class="actu">
        <div class="container">
            <h2>Actualités</h2>
            <p class="actu-intro">
                Retrouvez ici toutes les actualités de notre ville
            </p>
            ...
            <div class="actu-items">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="actu-item">
                            <div class="actu-item-img">
                                <a href="<?php the_permalink(); ?>"><?php the_post_thumbnail(); ?></a>
                            </div>
                            <div class="actu-item-content">
                                <h3 class="actu-item-title"><?php the_title(); ?></h3>
                                <!-- Get dynamic dateEv field in Admin -->
                                <?php $date = get_post_meta($post->ID, 'dateEv', true); ?>
                                <p class="actu-item-date"><?= $date ?></p>
                                <p class="actu-item-author"><i class="fa fa-pencil" aria-hidden="true"></i> <?php the_author(); ?></p>
                                <p class="actu-item-desc">
                                    <?= substr(strip_tags($post->post_content), 0, 160) ?>...<br>
                    ...
                    <?php endwhile; else: ?>
                    <p>Nous sommes désolés mais aucune manifestation n'est à prevoir prochainement...</p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
