                ...
                <div class="row">
                    <div class="navbar-content">
                        <div class="col-lg-3 col-md-9">
                            <div class="logo">
                                <a href="#"><img class="logo-img" src="<?php bloginfo('stylesheet_directory'); ?>/img/logo.png" alt="Logo Office du tourisme de Strasbourg"></a>
                            </div>
                        </div>
        ...
        <div class="container">
            ...
            <div class="actu-items">
                <div class="row">
                    <div class="col-lg-12">
                        <p>
                            Hum... Cette page n'existe pas ou n'existe plus.<br>
