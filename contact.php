...
<section class="contact actu">
    <h2>Contact</h2>
    <p class="contact-intro actu-intro">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <?php endwhile; else: ?>
                    <p>
                        Nous sommes désolé mais la page désirée n'est plus accessible! <br>
                        Contactez-nous à cette adresse: cyrilgouv@gmail.com
                    </p>
                    <?php endif; ?>
                </div>
                <div class="col-lg-6">
                    ...
                    <p class="contact-phone"><i class="fa fa-phone" aria-hidden="true"></i> 03.88.52.28.28</p>
                    <p class="contact-email"><i class="fa fa-envelope" aria-hidden="true"></i> info@otstrasbourg.fr</p>
                
                    <h3 class="contact-horaire">Horaires d'ouverture</h3>
                    <p class="contact-horaire-text"><i class="fa fa-clock-o" aria-hidden="true"></i> Tous les jours de 9H à 19H.</p>
                </div>
            </div>
        </div>
    </div>
